...
The APK will be at:
```
src/TwentyFortyEight.Maui/bin/Debug/net10.0-android/com.davidparks.twentyfourtyeight-Signed.apk
```
...
# Install the APK
adb install src/TwentyFortyEight.Maui/bin/Debug/net10.0-android/com.davidparks.twentyfourtyeight-Signed.apk
```
